...
@Component(
		...
		property = { "javax.portlet.name=" + CotizacionesPortlet73PortletKeys.PORTLET_NAME,
					 "mvc.command.name=/cotizacion/guardaComentario" },
		service = MVCResourceCommand.class
)

public class GuardaComentarioMVCResourceCommand extends BaseMVCResourceCommand{
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String comentario = ParamUtil.getString(resourceRequest, "comentario");
		...
		SimpleResponse simpleResponse = cotizadorService.guardarComentario(cotizacion, version, tipo, idComentario, comentario, usuario, pantalla);
		Gson gson = new Gson();
