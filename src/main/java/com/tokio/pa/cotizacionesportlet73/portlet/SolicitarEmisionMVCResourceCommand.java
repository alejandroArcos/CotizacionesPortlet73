...
@Component(
		...
		property = { "javax.portlet.name=" + CotizacionesPortlet73PortletKeys.PORTLET_NAME,
					 "mvc.command.name=/cotizacion/solicitarEmision" },
		service = MVCResourceCommand.class
)

public class SolicitarEmisionMVCResourceCommand extends BaseMVCResourceCommand{
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		SimpleResponse simpleResponse = cotizadorService.solicitarTMX(cotizacion, version, usuario, pantalla);
		Gson gson = new Gson();
