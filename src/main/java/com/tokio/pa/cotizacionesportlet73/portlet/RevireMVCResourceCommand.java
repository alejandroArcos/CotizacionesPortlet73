...
@Component(
		...
		property = { "javax.portlet.name=" + CotizacionesPortlet73PortletKeys.PORTLET_NAME,
					 "mvc.command.name=/cotizacion/revire" },
		service = MVCResourceCommand.class
)

public class RevireMVCResourceCommand extends BaseMVCResourceCommand{
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		SimpleResponse simpleResponse = cotizadorService.revire(cotizacion, version, comentario, usuario, pantalla, idPerfilUser);
		Gson gson = new Gson();
