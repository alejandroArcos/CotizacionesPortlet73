...
@Component(
		...
		property = { "javax.portlet.name=" + CotizacionesPortlet73PortletKeys.PORTLET_NAME,
					 "mvc.command.name=/cotizacion/pendientesAjax" },
		service = MVCResourceCommand.class
)

public class GetPendientesResultMVCResourceCommand extends BaseMVCResourceCommand{
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String cotizacion = ParamUtil.getString(resourceRequest, "idCotizador");
		...
		try{
			CotizacionResponse respuesta = cotizadorService.getCotizacion( folio,idPerfilUser,cotizacion,poliza,
					...
					moneda,producto,ramo,tipoMovimiento,tipoAgente, rowNum, idSolicitud, coaseguro, usuario,pantalla);
