 ...
 */
 	...
 	finInputA = $('#date-fechaFAgente').datepicker({ 
	    format : 'dd/mm/yyyy',
		formatSubmit : 'dd/mm/yyyy'
	});
   ...
   finInputT = $('#date-fechaFTokio').datepicker({ 
	    format : 'dd/mm/yyyy',
		formatSubmit : 'dd/mm/yyyy'
	});
  ...
  inicioInputA = $('#date-fechaIAgente').datepicker({ 
	    format : 'dd/mm/yyyy',
		formatSubmit : 'dd/mm/yyyy'
	});
 ...
 inicioInputT = $('#date-fechaITokio').datepicker({ 
	    format : 'dd/mm/yyyy',
		formatSubmit : 'dd/mm/yyyy'
	});
 

  inicioPickerT=inicioInputT.datepicker('picker');
			...
			if(response.code === 0){
				...
				for(let comentario of arrayComentarios){
					...
					/*comentarioHtml = "<li class='justify-content-between mb-3'>"
						...
						+"<small class='pull-right text-muted'><i class='fa fa-clock-o'></i>"+ comentario.fecha +"</small>"
						+"</div>"
						+"<hr class='w-100'>"
